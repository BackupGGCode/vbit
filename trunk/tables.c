...
unsigned char BitRev[16] PROGMEM = {
  '\x0','\x8','\x4','\xc',
  '\x2','\xa','\x6','\xe',
  '\x1','\x9','\x5','\xd',
  '\x3','\xb','\x7','\xf'
...
const char MragTable[8][LenMragMagEntry] PROGMEM = {
/*Mag 1 */
